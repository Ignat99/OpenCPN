...
void Label::CloneLabel( Label *psourcelabel, int start_nPoint, int end_nPoint, const wxString & suffix)
{
    ...
    for( i = start_nPoint; i <= end_nPoint; i++ ) {
        if( !psourcelabel->m_bIsInLayer ) AddPoint( psourcelabel->GetPoint( i ), false );
            ...
            LabelPoint *ptargetpoint = new LabelPoint( psourcepoint->GetIconName(), psourcepoint->GetNo(), psourcepoint->GetName(), psourcepoint->GetCName(), psourcepoint->GetPack(), psourcepoint->GetPcs(), psourcepoint->GetLast(), psourcepoint->GetCode(), psourcepoint->GetImage(), GPX_EMPTY_STRING, false );
        ...
        bool bRenamePoints )
{
    LabelPoint *newpoint = new LabelPoint( wxString( _T ( "diamond" ) ), wxString( _T ( "diamond" ) ), wxString( _T ( "diamond" ) ), 
            wxString( _T ( "diamond" ) ), wxString( _T ( "diamond" ) ), wxString( _T ( "diamond" ) ), wxString( _T ( "diamond" ) ),
