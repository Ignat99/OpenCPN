...
extern wxChoice *pDispCat;
extern wxChoice *pPointStyle;
extern wxChoice *pPointStyle1;
extern wxChoice *pBoundStyle;
extern wxChoice *p24Color;
extern wxButton *itemButtonClearList;
extern wxButton *itemButtonSelectList;
...
//size_t PlugInManager::CreatePanel(const wxString & title)
//{
